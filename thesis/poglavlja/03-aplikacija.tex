...
\begin{itemize}
    ...
    Pruža odvojene prikaze za nastavnike i studente: nastavnici upravljaju kursevima, testovima i pitanjima i pregledaju rešene testove, dok studenti rešavaju testove i uvidom u rezultate prate svoj napredak.
    Na prikazu rešenog testa, uz svaki odgovor prikazuju se i ocena nastavnika i ocena koju je predložio jezički model, čime nastavnik zadržava punu kontrolu nad konačnom odlukom.
    ...
    Izlaže CRUD operacije nad domenskim modelima i sadrži modul za ocenjivanje, odgovoran za sastavljanje promptova, pozivanje modela, parsiranje izlaza i trajno čuvanje rezultata.
...
Grupno ocenjivanje se u trenutnoj implementaciji ne pokreće iz korisničkog interfejsa: logika ocenjivanja izložena je kao funkcije serverskog modula za ocenjivanje, a eksperimenti opisani u poglavlju~\ref{sec:pipeline} pokreću je kroz DVC \emph{pipeline}, nad podacima pripremljenim u vidu CSV datoteka.
Izbor modela, režima ocenjivanja i nivoa strogosti zadaje se na tom nivou, kroz parametarske datoteke, a ne kroz veb interfejs.
...
Uz njih je prisutna i implementacija za Gugl Gemini, koja nije korišćena u eksperimentima opisanim u ovom radu.
