...
\begin{itemize}
    ...
    nad sistemom SQLite, sa entitetima za kurseve,
...
Autentifikacija koristi JWT, koji se čuva u \emph{session storage}-u pregledača (skladištu koje traje dok je kartica otvorena);
