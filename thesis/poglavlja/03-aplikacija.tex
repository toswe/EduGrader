...
Logika ocenjivanja i ponašanje modela tako se razvijaju nezavisno od korisničkog interfejsa;
...
Klijentska aplikacija je jednostranična aplikacija u biblioteci React (verzija 19) sa TypeScript jezikom,
...
Autentifikacija koristi JWT tokene koji se čuvaju u \emph{session storage}-u pregledača;
uloge (nastavnik ili student) ugrađene su u token i na osnovu njih se sprovodi kontrola pristupa rutama.
...
\begin{itemize}
    ...
    izdavanje i osvežavanje JWT tokena,
...
Više provajdera pokriveno je projektnim obrascem fabrika,
