...
Dodatak sadrži šablone promptova korišćene u eksperimentima i nekoliko primera ocenjivanja koje je sistem proizveo.
Promptovi su preneti verbatim iz konfiguracionih datoteka, sa izvornim nedoslednostima u dijakritici, jer su modeli primili upravo takav tekst.
...
Neutralna konfiguracija je namerno najkraća i ne uvodi dodatna pravila; blaga i stroga usmeravaju pažnju modela na poklapanja odnosno na nepoklapanja, a stroga zadaje i meru kazne.
...
Korak ne zavisi od konfiguracije strogosti; ona se primenjuje tek pri ocenjivanju, i to istim promptovima kao u PRA režimu.
...
Instrukcije za varijantu sa nastavnim materijalom neposredno u promptu (odeljak~\ref{sec:rezim-udzbenik}) razlikuju se od PRA verzija samo u opisu priloženog materijala.
