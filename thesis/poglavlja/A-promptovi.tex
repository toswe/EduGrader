...
U PRA režimu prompt uz sistemsku instrukciju sadrži pitanje, referentni odgovor nastavnika (u promptu označen kao „tačan odgovor'')
i studentski odgovor, svaki u zasebnom bloku.
