...
U ovom radu predstavljen je EduGrader, višemodelska platforma otvorenog koda za ocenjivanje koja objedinjuje više velikih jezičkih modela: GPT-4o, GPT-4o-mini, DeepSeek-Chat, GPT-5 i DeepSeek-Reasoner.
...
EduGrader je evaluiran na 583 autentična studentska odgovora sa pet univerzitetskih kurseva na dve institucije, uključujući tekstualna objašnjenja i odgovore u obliku koda.
U najboljoj konfiguraciji sistem postiže Pirsonov koeficijent korelacije od 0{,}89 sa ljudskim ocenjivačima, uz smanjenje opterećenja nastavnika i poboljšanje pouzdanosti, pri čemu je namenjen kao pomoć nastavnicima, a ne kao njihova zamena.

\vspace{1em}
\noindent\textbf{Ključne reči:} veliki jezički modeli, automatsko ocenjivanje, pitanja otvorenog tipa, referentni odgovor, srpski jezik, jezik sa ograničenim resursima, procena znanja u visokom obrazovanju, EduGrader.
\newpage
