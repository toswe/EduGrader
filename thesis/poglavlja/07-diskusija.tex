...
\begin{itemize}
    \item \textbf{Jedno pokretanje po konfiguraciji.} Svaka kombinacija modela, strogosti i režima izvršena je jednom, i to na podrazumevanoj temperaturi provajdera, pa rezultati ne obuhvataju procenu varijabilnosti između ponovljenih pokretanja istog modela ni uticaja temperature na doslednost ocenjivanja.
    \item \textbf{Nepotpuni treći režim.} Ocenjivanje sa nastavnim materijalom neposredno u promptu (odeljak~\ref{sec:rezim-udzbenik}) sprovedeno je samo delimično, jer je veličina prompta činila potpuni eksperiment nesrazmerno skupim. Pitanje da li bi izostavljanje posredničkog referentnog odgovora poboljšalo slaganje sa nastavnicima ostaje otvoreno.
