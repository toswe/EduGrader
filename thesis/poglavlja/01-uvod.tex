...
Koliko vremena se time stvarno štedi u ovom radu nije mereno.
...
\begin{enumerate}
    \item \textbf{Veb aplikacija EduGrader}, koju je autor projektovao i implementirao:
    ...
    \item \textbf{Sistem za automatizovanu evaluaciju modela}, koji je autor razvio:
    ...
    sa nastavničkim ocenama i referentnim odgovorima;
    ...
    parametrom koji upravlja slučajnošću pri uzorkovanju odgovora modela.
