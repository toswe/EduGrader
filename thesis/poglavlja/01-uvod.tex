...
U oba režima izlaz sistema ne čini samo numerička ocena, već i jasno obrazloženje koje ukazuje na jake strane odgovora, koncepte koji nedostaju i praznine u rezonovanju.
...
Model ocenu izražava na skali od 0 do 100, jer finija granulacija olakšava razlikovanje bliskih nivoa kvaliteta odgovora, a dobijena vrednost se zatim preslikava na skalu od 0 do 10, na kojoj ocenjuju nastavnici (detalji u odeljku~\ref{sec:pipeline}).
Zbog toga su sve ocene u ovom radu, i sistemske i nastavničke, prikazane na skali 0--10, osim tamo gde je izričito naznačeno drugačije.
...
Sistem je evaluiran na 583 autentična studentska odgovora prikupljena na dva univerziteta i pet kurseva, koji obuhvataju različite tipove odgovora: kratke činjeničke odgovore, otvorena tekstualna objašnjenja i odgovore u obliku koda.
...
Poglavlje~\ref{sec:rezultati} donosi rezultate eksperimenata, uključujući poređenje PRA i GRA režima kroz modele i nivoe strogosti, analizu uticaja konfiguracije strogosti i analizu korelacije po pojedinačnim kursevima.
