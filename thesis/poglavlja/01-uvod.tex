...
Takvo ocenjivanje je skupo, teško skalabilno i sklono nedoslednosti:
...
\begin{enumerate}
    ...
    \item Kako očuvati ljudsku odgovornost za konačne ocene, a iskoristiti efikasnost automatizacije?
\end{enumerate}
...
Svi eksperimenti sprovedeni su na srpskom,
jeziku sa ograničenim resursima koji je slabo zastupljen u podacima na kojima se veliki jezički modeli obučavaju,
...
\begin{enumerate}
    ...
    za proizvoljnu kombinaciju modela, konfiguracije strogosti i režima i računa metrike slaganja sa nastavnikom.
    \item \textbf{Skup podataka na srpskom jeziku}: 583 autentična studentska odgovora sa pet kurseva na dve institucije,
    sa nastavničkim ocenama i referentnim odgovorima (odeljak~\ref{sec:podaci}).
    ...
    \item \textbf{Empirijski nalazi}: referentni odgovor nastavnika dosledno poboljšava slaganje sa ljudskim ocenjivačima,
    modeli usmereni na rezonovanje su im najbliži, a stroga konfiguracija po pravilu pogoršava slaganje;
...
Poglavlje~\ref{sec:rezultati} donosi rezultate, uključujući poređenje PRA i GRA režima kroz modele i nivoe strogosti,
